(function (exports,main_core_events,ui_cnt,main_core) {
	...
	(function () {
		...
		var originalUpdatePageData = window.awz_ajax_proxy.UpdatePageData;

		function disableBxAjaxUpdatePageData() {
			window.awz_ajax_proxy.UpdatePageData = function () {};
		}

		function enableBxAjaxUpdatePageData() {
			window.awz_ajax_proxy.UpdatePageData = originalUpdatePageData;
		}
		/**
